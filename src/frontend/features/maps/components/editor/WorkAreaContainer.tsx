...
import { saveLayout, loadLayout } from "@/features/maps/services/layoutService.client";
...
export default function WorkAreaContainer({
    ...
    const { items, updateItem, addItem, setItems, deleteItem } = useWorkAreaItems();
